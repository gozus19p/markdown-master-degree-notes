...
1. [Sensi di una Parola e Relazioni](#relazioni-tra-sensi-delle-parole)
2. [WordNet](#wordnet)
    - Cos'è WordNet?
    - Livello Gerarchico Più Alto in WordNet
    - Rappresentazione di Eventi in WordNet
    - Utilizzo di WordNet
3. [Similarità di Parole e Distanza tra Parole](#distanza-e-similarità)
    - Cos'è la Similarità di Parole?
    - Differenza tra Similarità e Distanza tra Parole
    - Calcolare la Similarità con WordNet
4. [Embedding di Parole](#embedding-di-parole)
    - Cos'è un Embedding di Parole?
    - Dimensione degli Embedding
5. [Term Document Matrix](#term-document-matrix)
6. [Vettori Sparsi e Densi](#vettori-sparsi-e-densi)
7. [Coseno di similitudine](#coseno-di-similitudine)
